...
public class ConstantProp extends RelationProblem {
    ...
    Map factMap;
    ConstantPropFacts currentFacts;
        ...
        if (old_f != null) {
            ...
            if (fact != new_f && old_f.backPointers != null) {
                ...
                for (Iterator i = old_f.backPointers.iterator(); i.hasNext(); ) {
                    ...
                    if (old_f == new_f) {
                        if (TRACE) System.out.println("Relation is endpoint, using "+f+" instead.");
                        new_f = f;
                    }
    ...
    public class ConstantPropFact extends RelationFact {
        ...
        public ConstantPropFact getRepresentative() {
            ...
            while (f != f.representative) f = f.representative;
    ...
    public class ConstantPropFacts extends RelationFacts {
        ...
        public boolean equals(RelationFacts that) {
            if (this.relationFacts == that.relationFacts)
                return true;
            ...
            while (i.hasNext()) {
                ...
                if (!value.equals(value2)) {
                    if (TRACE) System.out.println("Key "+key+" differs: "+value+" vs "+value2);
                    return false;
                }
            }
            return true;
