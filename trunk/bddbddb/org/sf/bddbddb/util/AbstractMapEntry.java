 ...
 * involved in subclassing <code>java.util.Map.Entry</code>. For an immutable
 * entry, you need only implement <code>getKey()</code> and
 * <code>getValue()</code>. For a modifiable entry, you must also implement
 * <code>setValue()</code>; the default implementation throws an
...
public abstract class AbstractMapEntry/* <K,V> */implements Map.Entry/* <K,V> */{
     ...
     * removed from the backing map (by the iterator's <code>remove()</code>
     ...
     * (by the iterator's <code>remove()</code> operation).
     * 
