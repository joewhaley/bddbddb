 ...
 * <code>Map.Entry</code> ever: a pair! Basically saves coders the drugery of
 * writing an inner class at the expense of an import statement.
 * 
 * Note that <code>PairMapEntry</code> s <b>are </b> mutable:
 * <code>setValue(Object)</code> is defined in this class.
 * 
 * Using <code>null</code> as a key or value will not cause this class or
 * <code>AbstractMapEntry</code> to fail, but be warned that several
 * <code>Map</code> implementations do not like <code>null</code> s in their
 * internal structures.
 * 
