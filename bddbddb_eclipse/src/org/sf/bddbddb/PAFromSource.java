...
public class PAFromSource {
    ...
    int bddnodes = Integer.parseInt(System.getProperty("bddnodes", "100000"));
    int bddcache = Integer.parseInt(System.getProperty("bddcache", "10000"));
     ...
     * @throws IOException
     */
    public void run(List files) throws IOException {
        initializeBDD(null);
        initializeMaps();
